        ...
        <div className='!w-32 h-8 flex items-center justify-center' >
            <div className="ml-auto" >
                {followers.includes(`${currentUser.id}`) ?
                    <button onMouseEnter={() => setText("Stop following")} onMouseLeave={() => setText("followed")} onClick={follow} className='w-[120px] h-[30px] rounded-3xl border border-gray-600 flex items-center justify-center transition-all ml-auto hover:bg-blue-600 ' >
                        {fLoading ?
